using Pepper.Core.Interfaces;
using Pepper.Core.ProjectAggregate;
using Pepper.Core.ProjectAggregate.Events;
using Pepper.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace Pepper.UnitTests.Core.Handlers;
